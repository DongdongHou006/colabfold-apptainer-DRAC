...
- File Renaming: The output structures will have verbose tags like `_unrelaxed_rank_001_alphafold2_multimer_v3_model_1_seed_000`. Run the provided `scripts/rename_results.sh` to extract the `rank_001 files` and clean up their names for downstream analysis (e.g., PRODIGY, PPB-Affinity).
